...
public class UsersController : BaseController
{
    ...
    public async Task<IActionResult> CreateUser([FromBody] CreateUserRequest request, CancellationToken cancellationToken)
    {
        ...
        return Created(
            nameof(GetUser),
            response,
            _mapper.Map<CreateUserResponse>(response),
    ...
    public async Task<IActionResult> DeleteUser([FromRoute] Guid id, CancellationToken cancellationToken)
    {
        ...
        return Ok<object>(message: "User deleted successfully");
    }
    
    /// <summary>
    /// Lists users with pagination and optional filters
    /// </summary>
    /// <param name="request">List users request with pagination and filters</param>
    /// <param name="cancellationToken">Cancellation token</param>
    ...
    {
        var command = _mapper.Map<ListUsersQuery>(request);
        var response = await _mediator.Send(command, cancellationToken);

        return Ok(_mapper.Map<ListUsersResponse>(response), "Users listed successfully");
    }
