...
public class CreateCategoryHandlerTests
{
    ...
    public async Task Given_ValidCommand_When_Handle_Then_CategoryIsCreated()
    {
        ...
        var savedCategory = await context.Set<DeveloperEvaluation.Domain.Entities.Category>().FindAsync(result.Id);
    ...
    public async Task Given_DuplicateName_When_Handle_Then_ThrowsValidationException()
    {
        ...
        var existing = new DeveloperEvaluation.Domain.Entities.Category
        {
            Name = "Books",
            Description = "All kinds of books"
        };
        context.Set<DeveloperEvaluation.Domain.Entities.Category>().Add(existing);
