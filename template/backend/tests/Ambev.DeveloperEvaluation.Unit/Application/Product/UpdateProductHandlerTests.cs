...
public class UpdateProductHandlerTests
{
    ...
    public async Task Given_ValidCommand_When_Handle_Then_ProductIsUpdated()
    {
        ...
        context.Categories.Add(new DeveloperEvaluation.Domain.Entities.Category { Name = "new-category", Description = "new-description" });
        ...
        var product = new DeveloperEvaluation.Domain.Entities.Product
        {
            ...
            Category = new DeveloperEvaluation.Domain.Entities.Category{Name = "old-category", Description = "old-description"},
            Image = "old.png",
    ...
    public async Task Given_InvalidCommand_When_Handle_Then_ThrowsValidationException()
    {
        ...
        var product = new DeveloperEvaluation.Domain.Entities.Product
        {
            ...
            Price = 10,
            Description = "Valid",
            Category = new DeveloperEvaluation.Domain.Entities.Category {Name = "valid-category", Description = "valid-description"},
            Image = "valid.png",
            Rating = new Rating { Rate = 3, Count = 5 }
        };
    ...
    public async Task Given_RatingValues_When_Handle_Then_RatingUpdatedCorrectly()
    {
        ...
        var category = new DeveloperEvaluation.Domain.Entities.Category { Name = "category", Description = "desc-category" };
        ...
        Assert.NotNull(result);
        var updated = await context.Set<DeveloperEvaluation.Domain.Entities.Product>().FindAsync(product.Id);
