...
public class ListUsersHandlerTests
{
    ...
    public async Task Given_Filters_When_Handle_Then_FilteredUsersReturned()
    {
        ...
        var user1 = new DeveloperEvaluation.Domain.Entities.User
        {
            Id = Guid.NewGuid(),
            Username = "john.doe",
        ...
        var user2 = new DeveloperEvaluation.Domain.Entities.User
        {
            Id = Guid.NewGuid(),
            Username = "jane.doe",
        ...
        context.Set<DeveloperEvaluation.Domain.Entities.User>().AddRange(user1, user2);
        await context.SaveChangesAsync();
    ...
    public async Task Given_ExactPageSizeUsers_When_Handle_Then_TotalPagesCorrect()
    {
        ...
        for (var i = 0; i < 20; i++)
        {
            context.Set<DeveloperEvaluation.Domain.Entities.User>().Add(new DeveloperEvaluation.Domain.Entities.User
            {
                Id = Guid.NewGuid(),
                Username = $"user{i}",
                Email = $"user{i}@example.com",
